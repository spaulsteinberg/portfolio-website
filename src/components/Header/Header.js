    ...
    return (
        <div className={headerClasses.join(' ')}>
            ...
            <h3 className={classes.SubHeader}>
                ...
                My side projects are primarily developed using the MEAN (Mongo, Express, Angular, Node.js) with a passion
                for learning about new and emerging web technologies.
                </h3>
        </div>
    )
}
